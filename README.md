...
Программа написана на языке Python в основном с использованием стандартных модулей. Из модулей, не входящих в стандартную поставку, используются [html5lib](http://code.google.com/p/html5lib/) и lxml, которые, впрочем, присутствуют во всех нормальных дистрибутивах в виде пакетов. Работа программы тестировалась только в Python версии 2.7. Весьма вероятно, что проблем не будет и с версией 2.6, в более ранних работа не гарантируется.
